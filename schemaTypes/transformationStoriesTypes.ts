...
export const transformationStoriesTypes = defineType({
  name: 'transformationStories',
  title: 'Transformation Story',
  type: 'document',
  documentId: 'transformationStories',
  fields: [
    {
      name: 'slug',
      type: 'slug',
    ...
    },
    {
      ...
      fieldset: 'general',
      description:
        'Quote text without ""; Displayed as content preview when referenced in article lists',
    },
